...
#define AEP_DEFINE_ENUM_PARAMETER( NOT_USED1, NOT_USED2, GENERIC )											\
	class BOOST_PP_CAT( GENERIC, ParameterImpl )															\
		:	public BaseCheckerParameterImpl< BOOST_PP_CAT( GENERIC, Parameter ), GENERIC::Kind, GENERIC::Kind >	\
	{																										\
																											\
		typedef 																							\
			BaseCheckerParameterImpl< BOOST_PP_CAT( GENERIC, Parameter ), GENERIC::Kind, GENERIC::Kind >	\
			BaseClass;																						\
																											\
		public:																								\
